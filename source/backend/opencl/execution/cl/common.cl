...
#define GLOBAL_ID_CONDITION_2_DIMS(i) \
    (offset##i.x + global_size_dim0##i > get_global_id(0) && offset##i.y + global_size_dim1##i > get_global_id(1))

#define GLOBAL_ID_CONDITION_3_DIMS(i) \
    (offset##i.x + global_size_dim0##i > get_global_id(0) && offset##i.y + global_size_dim1##i  > get_global_id(1) && offset##i.z + global_size_dim2##i  > get_global_id(2))
