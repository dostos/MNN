...
void conv_2d_1x1_mali(GLOBAL_SIZE_2_DIMS(0) __private const int out_w_blocks, __read_only image2d_t input,
    ...
    DEAL_NON_UNIFORM_DIM2(0, 0, 0, out_c_w_idx, out_b_h_idx);
...
__kernel void conv_2d_1x1_local(GLOBAL_SIZE_3_DIMS(0) __read_only image2d_t input, __read_only image2d_t in_weights,
    ...
    DEAL_NON_UNIFORM_DIM3(0, 0, 0, 0, out_c_idx, out_w_idx, out_b_h_idx);
...
void conv_2d_1x1(GLOBAL_SIZE_2_DIMS(0) __read_only image2d_t input, __read_only image2d_t in_weights,
    ...
    DEAL_NON_UNIFORM_DIM2(0, 0, 0, output_channel_width_idx, output_batch_height_idx);
